    ...
    <div className="col-span-full w-full py-4">
      <div className="w-full min-h-[120px] bg-white/5 border border-white/10 rounded-3xl flex items-center justify-center overflow-hidden relative">
        ...
        <div className="relative z-10 w-full flex justify-center">
          ...
          {/* Fallback Label */}
          <div className="absolute top-2 right-4 text-[8px] font-bold text-slate-700 uppercase tracking-widest">
            Sponsored
          </div>
        </div>
      </div>
...
export const VerticalAd = ({ side }: { side: 'left' | 'right' }) => {
  return (
    <div className={`hidden 2xl:flex fixed top-48 ${side === 'left' ? 'left-4' : 'right-4'} w-[160px] h-[600px] bg-white/5 border border-white/10 rounded-3xl flex-col items-center justify-center overflow-hidden z-40 shadow-2xl shadow-black`}>
